...
func HistoryPanel(user *models.User) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<style>\n\t\t\t.sort-icon {\n\t\t\t\topacity: 0.3;\n\t\t\t\ttransition: opacity 0.2s, transform 0.2s;\n\t\t\t}\n\t\t\tth[data-sort]:hover .sort-icon {\n\t\t\t\topacity: 0.6;\n\t\t\t}\n\t\t\t.sort-icon.sort-active {\n\t\t\t\topacity: 1;\n\t\t\t\tcolor: #60a5fa;\n\t\t\t}\n\t\t\t.sort-icon.sort-desc {\n\t\t\t\ttransform: rotate(0deg);\n\t\t\t}\n\t\t\t.sort-icon.sort-asc {\n\t\t\t\ttransform: rotate(180deg);\n\t\t\t}\n\t\t\t.event-badge {\n\t\t\t\tdisplay: inline-flex;\n\t\t\t\talign-items: center;\n\t\t\t\tpadding: 0.25rem 0.75rem;\n\t\t\t\tfont-size: 0.75rem;\n\t\t\t\tfont-weight: 500;\n\t\t\t\tborder-radius: 9999px;\n\t\t\t}\n\t\t</style> <div class=\"space-y-6\"><!-- Header --><div class=\"flex flex-col sm:flex-row sm:items-center sm:justify-between\"><div><h1 class=\"text-3xl font-bold text-gray-100\">Activity History</h1><p class=\"mt-1 text-sm text-gray-400\">View the complete history of jellysweep actions including pickups, protection changes, and deletions.</p></div><div class=\"mt-4 sm:mt-0\"><button id=\"refresh-history-btn\" class=\"inline-flex items-center px-4 py-2 border border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-300 bg-gray-700 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200\"><svg class=\"w-4 h-4 mr-2\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15\"></path></svg> Refresh</button></div></div><!-- History Table -->")
			if templ_7745c5c3_Err != nil {
