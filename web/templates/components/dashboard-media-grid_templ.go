...
func DashboardMediaGrid(mediaItems []models.UserMediaItem, pageSize int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprint(pageSize))
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprint(len(mediaItems)))
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.ResolveAttributeValue(templ.JSONString(mediaItems))
		if templ_7745c5c3_Err != nil {
...
func DashboardFilters(mediaItems []models.UserMediaItem) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, library := range getUserMediaUniqueLibraries(mediaItems) {
			...
			templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.ResolveAttributeValue(library)
			if templ_7745c5c3_Err != nil {
...
func DashboardMediaGridScript() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_DashboardMediaGridScript_c361`,
		Function: `function __templ_DashboardMediaGridScript_c361(){class DashboardMediaGridManager extends MediaGridManager {
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		Call:       templ.SafeScript(`__templ_DashboardMediaGridScript_c361`),
		CallInline: templ.SafeScriptInline(`__templ_DashboardMediaGridScript_c361`),
	}
}
