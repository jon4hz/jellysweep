...
func AdminKeepRequestGrid(requestedMedia []models.AdminMediaItem) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprint(len(requestedMedia)))
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.ResolveAttributeValue(templ.JSONString(requestedMedia))
		if templ_7745c5c3_Err != nil {
...
func AdminKeepRequestFilters(requestedMedia []models.AdminMediaItem) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, library := range getUniqueRequestLibraries(requestedMedia) {
			...
			templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.ResolveAttributeValue(library)
			if templ_7745c5c3_Err != nil {
		...
		for _, mediaType := range getUniqueRequestTypes(requestedMedia) {
			...
			templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.ResolveAttributeValue(mediaType)
			if templ_7745c5c3_Err != nil {
...
func AdminMediaGrid(mediaItems []models.AdminMediaItem) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprint(len(mediaItems)))
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.ResolveAttributeValue(templ.JSONString(mediaItems))
		if templ_7745c5c3_Err != nil {
...
func AdminMediaFilters(mediaItems []models.AdminMediaItem) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, library := range getAdminMediaUniqueLibraries(mediaItems) {
			...
			templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.ResolveAttributeValue(library)
			if templ_7745c5c3_Err != nil {
		...
		for _, mediaType := range getAdminMediaUniqueTypes(mediaItems) {
			...
			templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.ResolveAttributeValue(string(mediaType))
			if templ_7745c5c3_Err != nil {
...
func AdminKeepRequestGridScript() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_AdminKeepRequestGridScript_4549`,
		Function: `function __templ_AdminKeepRequestGridScript_4549(){class AdminKeepRequestGridManager extends MediaGridManager {
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		Call:       templ.SafeScript(`__templ_AdminKeepRequestGridScript_4549`),
		CallInline: templ.SafeScriptInline(`__templ_AdminKeepRequestGridScript_4549`),
	}
}

func AdminMediaGridScript() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_AdminMediaGridScript_9039`,
		Function: `function __templ_AdminMediaGridScript_9039(){class AdminMediaGridManager extends MediaGridManager {
		constructor(containerId, options = {}) {
			super(containerId, options);
		}
								...
								<div class="mt-3 space-y-2">
									<div class="flex flex-wrap items-center gap-2 text-sm text-gray-400">
										...
										<div class="flex items-center text-sm text-blue-400">
											...
											Requested by ${this.escapeHtml(item.requestedBy)}
										</div>
										` + "`" + ` : ''}
									</div>
									<div class="flex items-center text-sm text-red-400">
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		Call:       templ.SafeScript(`__templ_AdminMediaGridScript_9039`),
		CallInline: templ.SafeScriptInline(`__templ_AdminMediaGridScript_9039`),
	}
}
